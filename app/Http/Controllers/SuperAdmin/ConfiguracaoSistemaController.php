...
class ConfiguracaoSistemaController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $dados = $request->validate([
            ...
            'cadastro_publico_ativo' => 'nullable|boolean',
            'antifraude_resgates_24h'      => 'nullable|integer|min:1|max:1000',
            'antifraude_ips_compartilhados'=> 'nullable|integer|min:1|max:1000',
            'antifraude_cadastros_dia_ip'  => 'nullable|integer|min:1|max:1000',
        ...
        $dados['cadastro_publico_ativo'] = $request->boolean('cadastro_publico_ativo');
