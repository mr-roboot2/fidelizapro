...
<div class="bg-white rounded-xl shadow-sm">
    <form method="GET" class="p-4 border-b border-slate-200 grid grid-cols-1 md:grid-cols-5 gap-2 items-end">
        ...
        <div class="md:col-span-5 flex justify-end gap-2">
            <a href="{{ route('admin.whatsapp-logs.index') }}" class="px-4 py-2 text-sm text-slate-600 hover:text-slate-800">Limpar</a>
    ...
    @include('_shared.whatsapp-logs-tabela', ['envios' => $envios, 'comEmpresa' => false])
