...
<body class="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl max-w-md p-8 text-center">
        ...
        <h1 class="text-xl font-bold text-slate-800 mb-2">Cadastro temporariamente indisponível</h1>
        <p class="text-slate-500 text-sm mb-6">
            Não há planos disponíveis no momento. Entre em contato pra saber quando vamos voltar a aceitar novas empresas.
        </p>
        <a href="/" class="inline-block px-6 py-2.5 rounded-lg font-semibold text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700">
